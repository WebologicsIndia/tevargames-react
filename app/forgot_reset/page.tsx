    ...
    <div className="forgot-container">
      <div className="forgot-content">
        ...
        <div className="forgot-navbar">
          <ArrowLeftOutlined className="forgot-back" onClick={handleBack} />
          <img src="/whitehjj.png" className="forgot-logo" alt="Logo" />
        </div>

        {/* HEADER */}
        <div className="forgot-header" style={{ backgroundImage: 'var(--main_gradient-color)' }}>
        ...
        <div className="forgot-phone-wrapper mb-[0.8rem]">
          ...
          <Input placeholder="Please enter the phone number" className="forgot-input forgot-phone-input" />
        </div>

        {/* PASSWORD */}
        <label className="forgot-label">
          <LockOutlined className="text-[0.64rem]" style={{ color: 'var(--main-color)' }} />A new password
        </label>
        ...
        <div className="forgot-code-wrapper mb-[0.8rem]">
          <Input placeholder="Please enter the confirmation code" className="forgot-code-input" />
          <button className="forgot-send-btn" onClick={() => console.log('Send code')}>
            Send
          </button>
        </div>
        ...
        <div className="mb-[0.76rem]">
          <Checkbox className="forgot-terms">
            <span className="forgot-terms-text">
              ...
              <span className="forgot-terms-link" onClick={() => router.push('/privacy-policy')}>
                【Privacy Agreement】
              </span>
            </span>
          </Checkbox>
