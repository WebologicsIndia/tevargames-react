    ...
    <ProtectedRoute>
      ...
      <div className="activity-icons">
        {activityIcon.map((item) => (
          <div key={item.name} className="icon-item" onClick={() => router.push(item.navigation)}>
      ...
      <div className="activity-card-wrapper">
        {activityCard.map((item) => (
          <div key={item.title} className="activity-card" onClick={() => router.push(item.navigation)}>
      ...
      <div className="activity-banner-wrapper">
        {activityBanner.map((item) => (
          <div key={item.title} onClick={() => router.push(item.navigation)}>
            <img alt={item.title} src={item.imageUrl} className="activity-banner" />
            <div className="activity-banner-text">{item.title}</div>
          </div>
        ))}
      </div>
