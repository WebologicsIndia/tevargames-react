...
const WinzoOffer = () => {
    ...
    return (
        <div className="newhot-page">
            ...
            {/* ================= TOP IMAGE ================= */}
            <img src = "/assets/activitybanner/activity-banner6.jpg" className="newhot-top-image"/>
            ...
            {/* ================= BIG IMAGE ================= */}
            <img src="/assets/activity/winzo.jpg" className="newhot-big-image"/>
        </div>
    );
};

export default WinzoOffer;
